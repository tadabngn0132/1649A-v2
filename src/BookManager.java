...
public class BookManager {
    ...
    public static ArrayList<Book> getBooks() {
        ...
        if (books == null) {
            ...
            books.add(new Book(9, "The Silmarillion", "J.R.R. Tolkien", 18.30, 25));
            ...
            books.add(new Book(10, "A Game of Thrones", "George R.R. Martin", 22.99, 50));
            ...
            books.add(new Book(11, "A Clash of Kings", "George R.R. Martin", 23.50, 30));
            books.add(new Book(7, "The Lord of the Rings: The Two Towers", "J.R.R. Tolkien", 19.99, 40));
        }
        return books;
    }
}
